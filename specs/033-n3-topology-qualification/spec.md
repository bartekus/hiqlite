...
**D-13 (2026-09-25, reland, not merged).** This change relands lane B, the revert of the
revert in D-12, on a branch that waits for `033`'s N=3 qualification. It merges only
