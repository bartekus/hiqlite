#!/usr/bin/env bash
# Source: statecraft-cli scripts/check-authored-content.sh at 9bb6188, adapted.
#
# The organization's authored-content rules (U+2014, session links), made mechanical.
#
